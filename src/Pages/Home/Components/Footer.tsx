...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#006401] text-white p-6 pt-16">
      <div className="max-w-screen-xl  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-10 mx-4">
        <div className="text-center md:text-start px-6 md:px-8 xl:ml-10">
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li>
              <Link
                to="https://makayiram.com/contact-us"
                className="hover:underline font-extralight"
              >
                Contact Us
              </Link>
            ...
            <li>
              <Link
                to="https://makayiram.com/flora&fauna"
                className="hover:underline font-extralight"
              >
                Flora & Fauna
              </Link>
        ...
        <div className="text-center md:text-start px-6 md:px-8">
          ...
          <ul className="mt-2 space-y-2">
            <li>
              <Link
                to="https://makayiram.com/RoomDetails/DoubleRooms"
                className="hover:underline font-extralight"
              >
                Twin Rooms
              </Link>
            ...
            <li>
              <Link
                to="https://makayiram.com/RoomDetails/apartments"
                className="hover:underline font-extralight"
              >
                Suites
              </Link>
            ...
            <li>
              <Link
                to="https://makayiram.com/RoomDetails/Suites"
                className="hover:underline font-extralight"
              >
                Apartment
              </Link>
            ...
            <li>
              <Link
                to="https://makayiram.com/RoomDetails/cottages"
                className="hover:underline font-extralight"
              >
                Cottages
              </Link>
        ...
        <div className="text-center md:text-start px-6 md:px-8">
          ...
          <ul className="mt-2 space-y-2">
            <li>
              <Link
                to="https://makayiram.com/activities"
                className="hover:underline font-extralight"
              >
                Cycling
              </Link>
            ...
            <li>
              <Link
                to="https://makayiram.com/Blogs/shinrin-yoku-immersing-oneself-in-the-spirit-of-nature_63"
                className="hover:underline font-extralight"
              >
                Shinrin Yoku
              </Link>
